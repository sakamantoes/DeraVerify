      ...
      <div className="w-full max-w-lg overflow-hidden rounded-2xl border border-gold-light/20 bg-[#111] shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-gold-dark px-4 text-sm font-bold text-white transition-colors hover:bg-gold"
          >
            Proceed with QUEST
            {loading ? (
