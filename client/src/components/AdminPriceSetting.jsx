    ...
    <section className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-gold-dark/40 via-black to-black p-6 text-white shadow-md sm:p-8">
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full rounded-lg border border-white/10 bg-black/40 px-8 py-2 text-white placeholder:text-gray-500 focus:border-gold-light/50 focus:outline-none focus:ring-1 focus:ring-gold-light/50"
            ...
            <div className="flex gap-4">
              <label className="flex items-center gap-2">
                <input
                  ...
                  className={`text-gold-500 focus:ring-gold-500 ${formData.markupType === "percentage" && "border-green-600 border"}`}
                />
        ...
        <button
          type="submit"
          disabled={loading}
          className="flex items-center justify-center mx-auto mt-4 w-full md:w-auto gap-3 rounded-xl border border-white/60 py-2 px-8 text-left transition-all bg-gradient-to-br to-gold-dark/40 via-black disabled:cursor-not-allowed disabled:opacity-60"
        >
          {loading ? (
